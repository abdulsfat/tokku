...
export const ProductForm: React.FC<ProductFormProps> = ({initialData, categories}) => {
    ...
    const toastMessage = initialData ? "Successfully Edit Product" : "Successfully create Product"
                    ...
                    <div className="grid grid-cols-3 gap-8">
                        <FormField
                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input placeholder="Name Product" disabled={loading} {...field}/>
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                            ...
                            render={({field}) => (
                                <FormItem className="flex flex-row item-start space-x-3 space-y-0 rounded-md border p-4">
                                    ...
                                    <div className="space-y-1 leading-none">
                                        ...
                                        <FormDescription>
                                            This product will disappear on the home page
                                        </FormDescription>
                                    </div>
                                </FormItem>
                            )}
